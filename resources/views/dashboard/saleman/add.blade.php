        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Add Saleman</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ route('salemans.store') }}">
                            @csrf
                              ...
                              <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                  <div class="form-group">
                                      <div class="controls">
                                         ...
                                         <input type="email" class="form-control" id="designation" name="designation" value="{{ old('designation') }}" required>
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                  <div class="form-group">
                                      <div class="controls">
                                         ...
                                         <input type="number" class="form-control" id="contactNumber" name="contactNumber" value="{{ old('contactNumber') }}" required>
                                      </div>
                                  </div>
                              </div>
