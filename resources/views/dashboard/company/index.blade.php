                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            @if (superAdmin())
                              <a href="{{ route('company.create') }}" class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1">Add Company</a>
                            @endif
                        </div>
                                    ...
                                    <tbody>
                                      ...
                                      @else
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                             <a  href="{{ route('company.edit',$company->id) }}"><i class="fa fa-edit d-inline">  </i></a>
                                             <form class="d-inline" action="{{ route('company.destroy' , $company->id) }}" method="post">
                                                 @csrf
