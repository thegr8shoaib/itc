            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ route('editProduct', $product->id) }}">
                            @csrf
                            <div class="row mt-1">
                                ...
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                    <div class="form-group">
                                        <div class="controls">
                                            <label for="puchasePrice">Purchase Price :</label>
                                           <input type="number" class="form-control" id="puchasePrice" name="puchasePrice" value="{{ old('puchasePrice') }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                    <div class="form-group">
                                        <div class="controls">
                                            <label for="sailPrice">Sail Price :</label>
                                           <input type="number" class="form-control" id="sailPrice" name="sailPrice" value="{{ old('sailPrice') }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                    <div class="form-group">
                                        <div class="controls">
                                           ...
                                           <input type="number" class="form-control" id="slevel" name="stocklevel" value="{{ old('slevel') }}" required>
                                        </div>
                                    </div>
                                </div>
