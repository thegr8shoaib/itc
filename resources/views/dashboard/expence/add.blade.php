        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Add Expence</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ route('expence.store') }}">
                            @csrf
                              ...
                              <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                  <div class="form-group">
                                      <div class="controls">
                                         ...
                                         <input type="text" class="form-control" id="discription" name="discription" value="{{ old('discription') }}" required>
                                      </div>
                                  </div>
                              </div>
